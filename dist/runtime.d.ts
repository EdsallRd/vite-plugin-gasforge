...
interface ServerFnQueryExtensions<TInput extends StandardSchemaV1, TOutput extends StandardSchemaV1> {
    local: (...args: StandardSchemaV1.InferInput<TInput> extends void ? [input?: StandardSchemaV1.InferInput<TInput>] : [input: StandardSchemaV1.InferInput<TInput>]) => Promise<StandardSchemaV1.InferOutput<TOutput>>;
...
export { GASForgeError, type GASForgeErrorCode, type InferMiddlewareContext, type Middleware, type ServerFn, type ServerFnQueryExtensions, createMiddleware, createServerFn };
